...
RMODS=(
  ...
  $P/Corridor/Running/LocatedLaw $P/Corridor/Running/CrossCut $P/Corridor/Running/DedekindBridge $P/Corridor/Running/CertifiedSqrt $P/Corridor/Running/SpectralEdge $P/Corridor/Running/General/Metallic $P/Corridor/Running/General/MetallicEdge $P/Corridor/Running/General/OperatorNorm $P/Corridor/Running/General/OperatorNormSpectral $P/Corridor/Running/General/OperatorNormMagnitude $P/Corridor/Running/General/AdjointForm $P/Corridor/Running/General/AdjointFormN $P/Corridor/Running/General/SpectralCStar $P/Corridor/Running/General/GelfandPower $P/Corridor/Running/General/LocatedReal $P/Corridor/Running/General/EntropyRing $P/Corridor/Running/General/EntropyProvenance
)
for m in "${RMODS[@]}"; do
